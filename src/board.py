...
class Board:
    ...
    def fit_piece(self, piece, player, opponent_player, mode="player"):
        ...
        if player.is_1st_move:
            ...
            elif player.number == constants.PLAYER3_VALUE:
                pos = constants.STARTING_PTS["player3"]
            elif player.number == constants.PLAYER4_VALUE:
                pos = constants.STARTING_PTS["player4"]
...
def send_score(score_p1, score_p2, score_p3, score_p4, email):
    # Set username and App Passwords for Google Mail
    # For testing, probably you don't have to change it
    username = 'blockbattleprogjar@gmail.com'
    password = 'rvlnzjjemqailocb'
    ...
    Message = 'The games match score is' + '\n' + 'Player 1: ' + str(score_p1) + '\n' + 'Player 2: ' + str(score_p2) + 'Player 3: ' + str(score_p3) + 'Player 4: ' + str(score_p4) + '\n'
    max = max(int(score_p1), int(score_p2), int(score_p3), int(score_p4))
    
    if max == score_p1 and max == score_p2:
        Message += 'Player 1 and 2 draw!'
    elif max == score_p1 and max == score_p3:
        Message += 'Player 1 and 3 draw!'
    elif max == score_p1 and max == score_p4:
        Message += 'Player 1 and 4 draw!'
    elif max == score_p2 and max == score_p3:
        Message += 'Player 2 and 3 draw!'
    elif max == score_p2 and max == score_p4:
        Message += 'Player 2 and 4 draw!'
    elif max == score_p3 and max == score_p4:
        Message += 'Player 1 and 3 draw!'
    elif max == score_p1 and max == score_p2 and max == score_p3:
        Message += 'Player 1, 2 and 3 draw!'
    elif max == score_p1 and max == score_p2 and max == score_p4:
        Message += 'Player 1, 2 and 4 draw!'
    elif max == score_p1 and max == score_p3 and max == score_p4:
        Message += 'Player 1, 3 and 4 draw!'
    elif max == score_p2 and max == score_p3 and max == score_p4:
        Message += 'Player 2, 3 and 4 draw!'
    elif max == score_p1:
    ...
    msg['Subject'] = 'Blockbattle App Score Report'
