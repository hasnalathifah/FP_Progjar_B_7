...
class Player:
    players = [constants.PLAYER1_VALUE, constants.PLAYER2_VALUE, constants.PLAYER3_VALUE, constants.PLAYER4_VALUE]
    ...
    def __init__(self, player_number: int, color: list):
        ...
        # if self.number == constants.PLAYER1_VALUE:
        #     self.is_1st_move = True 
        #     self.is_2nd_move = False
        #     self.is_3th_move = False
        #     self.is_4th_move = False
        # elif self.number == constants.PLAYER2_VALUE:
        #     self.is_1st_move = False 
        #     self.is_2nd_move = True
        #     self.is_3th_move = False
        #     self.is_4th_move = False
        # elif self.number == constants.PLAYER3_VALUE:
        #     self.is_1st_move = False 
        #     self.is_2nd_move = False
        #     self.is_3th_move = True
        #     self.is_4th_move = False
        # elif self.number == constants.PLAYER4_VALUE:
        #     self.is_1st_move = False 
        #     self.is_2nd_move = False
        #     self.is_3th_move = False
        #     self.is_4th_move = True
